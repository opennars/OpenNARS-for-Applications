...
emcc $@ -sEXPORTED_FUNCTIONS=_NAR_INIT,_NAR_AddInputNarsese,_free -sEXPORTED_RUNTIME_METHODS=stringToNewUTF8 -sSTACK_SIZE=10485760 -DSTAGE=2 $NoWarn $BaseFlags -s TOTAL_MEMORY=900mb src/RuleTable.c
echo "Done."
