...
$CC -mfpmath=sse -msse2 -DSTAGE=2 $NoWarn $BaseFlags $@ src/RuleTable.c || (echo "Error with SSE, hence compiling without SSE:" && $CC -DSTAGE=2 $NoWarn $BaseFlags $@ src/RuleTable.c)
echo "Done."
